...
import proj1 from "../../public/images/projects/cladire-visarion-cover-image.jpg";
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Adrian Pena | Proiecte</title>
        <meta
          name="description"
          content="Descopera o serie de proiecte la care am lucrat sau pe care le-am executat de-a lungul activitatii mele"
        />
      </Head>
