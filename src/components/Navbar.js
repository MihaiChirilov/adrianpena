    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav className="flex items-center justify-center">
          <CustomLink className="mr-4" href="/" title="Acasa" />
          <CustomLink className="mx-4" href="/about" title="Despre" />
          <CustomLink className="mx-4" href="/projects" title="Proiecte" />
          <CustomLink className="ml-4" href="/articles" title="Articole" />
        </nav>
        <nav
